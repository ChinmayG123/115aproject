...
class Server:
    ...
    def parse_request(self, data):
        ...
        self.Request["Method"], self.Request["URI"], self.Request["Version"] = request_line
    ...
    def compose_response(self):
        ...
        response = f"{self.Response['Version']} {self.Response['StatusCode']} {self.Response['StatusLine']}\r\n" + \
